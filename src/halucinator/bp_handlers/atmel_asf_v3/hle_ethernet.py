...
class Ksz8851HLE(BPHandler):
    ...
    def call_populate_queues(self, qemu):
        ...
        qemu.regs.lr = qemu.regs.pc | 1 # Make sure thumb bit is set, lr already saved on stack
    ...
    def low_level_output(self, qemu, bp_addr):
        ...
        while p != 0: 
            ...
            frame_bufs.append(qemu.read_memory(payload_ptr +padding, 1, length-padding, raw=True))
